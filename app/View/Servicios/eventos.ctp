...
<div class="modal fade" id="addSolicitud" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" style="max-width:900px !important">
		<div class="modal-content">
			...
			<?= $this->Form->create('Servicio', array('type' => 'file', 'url' => array('action' => 'addEvento'), 'class' => 'form-horizontal')) ?>
						...
						<table id="quotationTable" style="width: 100%">
							...
							<tbody>
								<tr class="quotation-row" data-index="0">
									<td>
										<select name="data[Cotizacion][0][concepto]"
			...
			<div class="modal-footer">
				...
				<?= $this->Form->submit('Enviar Solicitud de Servicio', array('class' => 'btn btn-success pull-left', 'id' => 'botonSubmitJugador')) ?>
			</div>
			<?= $this->Form->end() ?>
		</div>
	</div>
					...
					<div class="col-12">
						...
						<table style="width:100%">
							...
							<tr>
								...
								<td><b>Supervisor de Evento: </b><span id="supervisor_evento_view"></span></td>
							</tr>
							<tr>
							...
							<tbody>
								...
								foreach ($eventos as $solicitud):
									...
									<tr>
										...
										<td><?= $solicitud['Servicio']['nombre_evento'] ?></td>
										<td><?= date("d/M/Y H:i:s", strtotime($solicitud['Servicio']['fecha_servicio'])) ?>
										</td>
										<td><?= $solicitud['Servicio']['direccion'] ?></td>
