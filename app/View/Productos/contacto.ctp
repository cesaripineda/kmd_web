...
<section class="u-align-center u-clearfix u-section-1" id="block-1">
	<div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
		<?php
			if(isset($confirm)){
				echo "<div style='background-color: #2bd42b;color: white;padding: 10px;'>¡Gracias por ponerte en contacto con nosotros. En breve nos pondremos en contacto contigo.</div>";
			}
		?>
		...
		<div class="u-align-left u-form-1">
			<?= $this->Form->create('Contacto',array('url'=>array('action'=>'sendMail','controller'=>'productos'))) ?>
